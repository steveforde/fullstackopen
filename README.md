...
The project workspace is modularly broken down by sequential submission tasks:

- `Task-0` to `Task-2` — Fundamental React rendering and web app foundations.
- `Task-3` to `Task-5` — Node.js/Express backend integration, MongoDB aggregation, and full-stack token authentication.
- `Task-6` & `Task-7-Bloglist` — Advanced state architecture, material design layout systems, client-side routing, and robust optimization.
